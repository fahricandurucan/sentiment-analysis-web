      ...
      fetch("/country.json")
        ...
        .then((data) => {
          const filteredPosts = data.filter(
            (post) => post.country.toLowerCase() === decodeURIComponent(countryName).toLowerCase()
          );
  ...
  return (
    <div className="min-h-screen bg-purple-50">
      ...
      <div className="container mx-auto p-6 mt-16 flex flex-col items-center">
        ...
        •​Posts from {decodeURIComponent(params.country)}•
        </h1>
        <div className="w-full max-w-2xl grid gap-4">
          {currentPosts.length > 0 ? (
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <p className="text-gray-600">No posts available for this country.</p>
            </div>
          )}
        </div>
        {totalPages > 1 && (
